...
public class PySliceObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_POINTER.withName("start"),
        Python_h.C_POINTER.withName("stop"),
        Python_h.C_POINTER.withName("step")
    ).withName("$anon$26:9");
    ...
    private static final long stop$OFFSET = 24;
    ...
    private static final AddressLayout step$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("step"));
     ...
     * }
     */
    public static final AddressLayout step$layout() {
        return step$LAYOUT;
    }

    private static final long step$OFFSET = 32;
     ...
     * }
     */
    public static MemorySegment step(MemorySegment struct) {
     ...
     * }
     */
    public static void step(MemorySegment struct, MemorySegment fieldValue) {
