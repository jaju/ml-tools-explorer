...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Python_h.C_INT.withName("sigev_notify"),
        Python_h.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        Python_h.C_POINTER.withName("sigev_notify_function"),
        Python_h.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = Python_h.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
