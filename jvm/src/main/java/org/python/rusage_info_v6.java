...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_LONG_LONG.withName("ri_child_user_time"),
        Python_h.C_LONG_LONG.withName("ri_child_system_time"),
        Python_h.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        Python_h.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        Python_h.C_LONG_LONG.withName("ri_child_pageins"),
        Python_h.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        Python_h.C_LONG_LONG.withName("ri_diskio_bytesread"),
        Python_h.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        Python_h.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        Python_h.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        Python_h.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        Python_h.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        Python_h.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        Python_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        Python_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        Python_h.C_LONG_LONG.withName("ri_billed_system_time"),
        Python_h.C_LONG_LONG.withName("ri_serviced_system_time"),
        Python_h.C_LONG_LONG.withName("ri_logical_writes"),
        Python_h.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        Python_h.C_LONG_LONG.withName("ri_instructions"),
        Python_h.C_LONG_LONG.withName("ri_cycles"),
        Python_h.C_LONG_LONG.withName("ri_billed_energy"),
        Python_h.C_LONG_LONG.withName("ri_serviced_energy"),
        Python_h.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        Python_h.C_LONG_LONG.withName("ri_runnable_time"),
        Python_h.C_LONG_LONG.withName("ri_flags"),
        Python_h.C_LONG_LONG.withName("ri_user_ptime"),
        Python_h.C_LONG_LONG.withName("ri_system_ptime"),
        Python_h.C_LONG_LONG.withName("ri_pinstructions"),
        Python_h.C_LONG_LONG.withName("ri_pcycles"),
        Python_h.C_LONG_LONG.withName("ri_energy_nj"),
        Python_h.C_LONG_LONG.withName("ri_penergy_nj"),
        Python_h.C_LONG_LONG.withName("ri_secure_time_in_system"),
        Python_h.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        Python_h.C_LONG_LONG.withName("ri_neural_footprint"),
        Python_h.C_LONG_LONG.withName("ri_lifetime_max_neural_footprint"),
        Python_h.C_LONG_LONG.withName("ri_interval_max_neural_footprint"),
        MemoryLayout.sequenceLayout(9, Python_h.C_LONG_LONG).withName("ri_reserved")
