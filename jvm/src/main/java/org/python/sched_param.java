...
public class sched_param {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Python_h.C_INT.withName("sched_priority"),
        MemoryLayout.sequenceLayout(4, Python_h.C_CHAR).withName("__opaque")
    ...
    private static final long __opaque$OFFSET = 4;
    ...
    private static long[] __opaque$DIMS = { 4 };
