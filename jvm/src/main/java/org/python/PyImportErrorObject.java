 ...
 * }
 */
public class PyImportErrorObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_POINTER.withName("path"),
        Python_h.C_POINTER.withName("name_from")
    ).withName("$anon$35:9");
    ...
    private static final long path$OFFSET = 88;
    ...
    private static final AddressLayout name_from$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("name_from"));
     ...
     * }
     */
    public static final AddressLayout name_from$layout() {
        return name_from$LAYOUT;
    }

    private static final long name_from$OFFSET = 96;
     ...
     * }
     */
    public static final long name_from$offset() {
        return name_from$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment name_from(MemorySegment struct) {
        return struct.get(name_from$LAYOUT, name_from$OFFSET);
    }
     ...
     * }
     */
    public static void name_from(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(name_from$LAYOUT, name_from$OFFSET, fieldValue);
    }
