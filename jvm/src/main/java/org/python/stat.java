...
public class stat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_LONG_LONG.withName("st_ino"),
        Python_h.C_INT.withName("st_uid"),
        Python_h.C_INT.withName("st_gid"),
        ...
        Python_h.C_LONG_LONG.withName("st_blocks"),
        Python_h.C_INT.withName("st_blksize"),
        Python_h.C_INT.withName("st_flags"),
        Python_h.C_INT.withName("st_gen"),
        Python_h.C_INT.withName("st_lspare"),
        MemoryLayout.sequenceLayout(2, Python_h.C_LONG_LONG).withName("st_qspare")
    ).withName("stat");
