...
public class PyCellObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_POINTER.withName("ob_ref")
    ).withName("$anon$10:9");
    ...
    private static final AddressLayout ob_ref$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("ob_ref"));
     ...
     * }
     */
    public static final AddressLayout ob_ref$layout() {
        return ob_ref$LAYOUT;
    }

    private static final long ob_ref$OFFSET = 16;
     ...
     * }
     */
    public static final long ob_ref$offset() {
        return ob_ref$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ob_ref(MemorySegment struct) {
        return struct.get(ob_ref$LAYOUT, ob_ref$OFFSET);
    }
     ...
     * }
     */
    public static void ob_ref(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(ob_ref$LAYOUT, ob_ref$OFFSET, fieldValue);
    }
