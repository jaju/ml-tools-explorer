...
public class PyComplexObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Py_complex.layout().withName("cval")
    ).withName("$anon$26:9");
    ...
    private static final GroupLayout cval$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("cval"));
     ...
     * }
     */
    public static final GroupLayout cval$layout() {
        return cval$LAYOUT;
    }
     ...
     * }
     */
    public static MemorySegment cval(MemorySegment struct) {
        return struct.asSlice(cval$OFFSET, cval$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void cval(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, cval$OFFSET, cval$LAYOUT.byteSize());
    }
