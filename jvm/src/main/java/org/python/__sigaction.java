...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_POINTER.withName("sa_tramp"),
        Python_h.C_INT.withName("sa_mask"),
        Python_h.C_INT.withName("sa_flags")
    ...
    public static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = Python_h.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
