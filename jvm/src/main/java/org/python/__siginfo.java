...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Python_h.C_INT.withName("si_signo"),
        Python_h.C_INT.withName("si_errno"),
        Python_h.C_INT.withName("si_code"),
        Python_h.C_INT.withName("si_pid"),
        Python_h.C_INT.withName("si_uid"),
        Python_h.C_INT.withName("si_status"),
        Python_h.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        Python_h.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, Python_h.C_LONG).withName("__pad")
    ).withName("__siginfo");
