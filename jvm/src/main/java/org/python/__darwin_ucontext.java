...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Python_h.C_INT.withName("uc_onstack"),
        Python_h.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        Python_h.C_POINTER.withName("uc_link"),
        Python_h.C_LONG.withName("uc_mcsize"),
        Python_h.C_POINTER.withName("uc_mcontext")
