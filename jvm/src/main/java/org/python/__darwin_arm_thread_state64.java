...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, Python_h.C_LONG_LONG).withName("__x"),
        Python_h.C_LONG_LONG.withName("__fp"),
        Python_h.C_LONG_LONG.withName("__lr"),
        Python_h.C_LONG_LONG.withName("__sp"),
        Python_h.C_LONG_LONG.withName("__pc"),
        Python_h.C_INT.withName("__cpsr"),
        Python_h.C_INT.withName("__pad")
